...
#' @param x Set of data
#' @param param Sequence of values of which to range the plot
#' @param ... Other graphical properties and parameters for the plot output
#'
#' @return Returns a plot representing the logarithmic function alongside a point where the maximum likelihood is
#' @export
#'
#' @examples
