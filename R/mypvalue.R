#' @title P-value Areas
#'
#' @param t0 An initial T value
#' @param xmax Maximum x on graph
#' @param n Sample size
#' @param alpha Confidence Alpha
#'
#' @return Returns a plot distributed normally with quantiles
#' marked alongside a shaded region of probability estimates
#' @export
#'
#' @examples \dontrun{tcalc=(mean(x1)-24)/(sd(x1)/sqrt(30));mypvalue(tcalc,n=30,alpha=0.05)}
